...
public class PutAPITest extends TestBase{
    ...
    public void putAPITest() throws JsonGenerationException, JsonMappingException, IOException {
        ...
        UsersPut users = new UsersPut("morpheus", "zion resident"); // expected users object

        // object to json convertion
        mapper.writeValue(new File("/Users/yamuna/eclipse-workspace/HTTPClientFramework/src/main/java/com/qa/data/usersPut.json"),users);
        ...
        response = restClient.put(url, usersJsonString, headerMap);
        ...
        UsersPut usersResObj = mapper.readValue(responseString, UsersPut.class); // actual users object
